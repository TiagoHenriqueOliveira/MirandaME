						...
						<ul class="nav" id="side-menu">
							<li>
								...
								<ul class="nav nav-second-level">
									<li>
										<a href="index.php?route=bem&action=register"><i class="fa fa-save fa-fw"></i> Cadastrar </a>
									</li>
									<li>
							...
							<li>
								...
								<ul class="nav nav-second-level">
									<li>
										<a href="index.php?route=fornecedor&action=register"><i class="fa fa-save fa-fw"></i> Cadastrar </a>
									</li>
									<li>
							...
							<li>
								...
								<ul class="nav nav-second-level">
									<li>
										<a href="index.php?route=funcionario&action=register"><i class="fa fa-save fa-fw"></i> Cadastrar </a>
									</li>
									<li>
							...
							<li>
								...
								<ul class="nav nav-second-level">
									<li>
										<a href="index.php?route=local&action=cadastrar"><i class="fa fa-save fa-fw"></i> Cadastrar </a>
									</li>
									<li>
								...
								<ul class="nav nav-second-level">
									<li>
										...
										<ul class="nav nav-third-level">
											<li>
												<a href="index.php?route=termo/responsabilidade&action=register"><i class="fa fa-save fa-fw"></i> Cadastrar </a>
											</li>
											<li>
									...
									<li>
										...
										<ul class="nav nav-third-level">
											<li>
												<a href="index.php?route=termo/transferencia&action=register"><i class="fa fa-save fa-fw"></i> Cadastrar </a>
											</li>
											<li>
